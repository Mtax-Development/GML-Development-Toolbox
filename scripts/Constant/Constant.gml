...
/// @argument			value? {any}
/// @description		Container for a value that is supposed to be unchaning. It is numerated by
///						specifying either a number or a struct to use the amount of properties it had
///						before this construction was finished.
//						
//						Construction types:
//						- New constructor
